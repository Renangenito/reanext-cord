...
const SUPABASE_ANON_KEY =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyb2xlIjoiYW5vbiIsImlhdCI6MTY0MzQ4MzY5OCwiZXhwIjoxOTU5MDU5Njk4fQ.7AxUoVciX0EaN1Mw3BsLRrqKLpOM74Y3A5ulIAikUtA";
const SUPABASE_URL = "https://xlqbuwalbxoosoxlzjxn.supabase.co";
        ...
        return (
          ...
          >
            ...
            {mensagem.texto.startsWith(':sticker:')
              ? (
                <Image styleSheet={{width: '40%'}} src={mensagem.texto.replace(':sticker:', '')} />
              )
              : (
                mensagem.texto
              )}
